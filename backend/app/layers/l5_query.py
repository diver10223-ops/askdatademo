...
class QueryLayer:
 ...
 async def execute(self,c):
  ...
  if table!='dws_loan_aggr_wide' or metric not in {'loan_cur','retail_cur','corporate_cur'}: return LayerResult('FAILED',{'message':'资产映射不在一期白名单'},True,'SQL_GENERATION_FAILED')
