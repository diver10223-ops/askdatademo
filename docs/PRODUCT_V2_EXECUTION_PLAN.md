...
| 6 | M1—M7 产品基线 | IN PROGRESS | M6已通过，下一步P370完整测试体系 |
| 7 | M8—M9 客户交付 | BLOCKED | 等待具体客户环境和验收输入 |

P300—P303已完成，M0门禁通过。稳定演示工作树位于`/workspaces/askdatademo-v1-v2-demo`，V2.0开发工作树位于`/workspaces/askdatademo`；M1—M6已完成，下一步执行M7的P370。
