...
| 4 | P303 工作树隔离 | NOT STARTED | 标签与分支建立后配置 |
| 5 | P310 服务职责冻结 | NOT STARTED | M0通过后启动 |
| 6 | M1—M7 产品基线 | NOT STARTED | 按依赖顺序实施 |
| 7 | M8—M9 客户交付 | BLOCKED | 等待具体客户环境和验收输入 |

P300—P302已完成；交付文档已按实际结果重新生成并固化，下一步执行P303演示与开发工作树隔离。
...
P301 重跑完整门禁
  ↓
P302 提交稳定分支、创建标签和release/product-v2-test
  ↓
P303 建立演示/开发双工作树
  ↓
M1 产品V2.0骨架与契约
...
不得跳过P300—P303直接进行会影响稳定演示或迁移基线的产品V2.0编码。
