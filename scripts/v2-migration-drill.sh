...
start_platform() {
  ...
  ASKDATA_INTERNAL_SERVICE_TOKEN=askdata-migration-isolated-test-token \
  ASKDATA_PLATFORM_API_TOKEN=askdata-migration-platform-api-token-32-bytes-minimum \
...
export ASKDATA_APP_VERSION=2.0.0 ASKDATA_SOURCE_COMMIT="$(git -C "$repo_root" rev-parse HEAD)" ASKDATA_DB_ENGINE=h2 ASKDATA_H2_JAR="$h2_jar"
